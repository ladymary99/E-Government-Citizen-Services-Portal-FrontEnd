...
const ManageServices = () => {
  ...
  const [formData, setFormData] = useState({ name: '', description: '', fee: '', department_id: '' });
  ...
  const fetchServices = async () => {
    try {
      ...
      setServices([
        { id: 1, name: 'Business License', fee: 100, department_name: 'Commerce', description: 'New business registration' },
        { id: 2, name: 'ID Renewal', fee: 50, department_name: 'Interior', description: 'National ID renewal service' },
      ]);
    }
  };
  ...
  const fetchDepartments = async () => {
    try {
      ...
      setDepartments([{ id: 1, name: 'Commerce' }, { id: 2, name: 'Interior' }]);
    }
  };
  ...
  const openModal = (service = null) => {
    ...
    setFormData(service || { name: '', description: '', fee: '', department_id: '' });
    setShowModal(true);
  };
    ...
    <Layout menuItems={menuItems} title="Admin Portal">
      ...
      >
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '32px' }}>
          <h2 style={{ fontSize: '28px', fontWeight: '600' }}>Manage Services</h2>
                  ...
                  <tr key={service.id}>
                    ...
                    <td>
                      <div style={{ display: 'flex', gap: '8px' }}>
                        <button className="btn btn-outline btn-sm" onClick={() => openModal(service)}>
                          <Edit size={16} />
                        </button>
            ...
            <form onSubmit={handleSubmit}>
              <div className="modal-body">
                ...
                <div className="form-group">
                  ...
                  <input type="number" className="form-input" value={formData.fee}
